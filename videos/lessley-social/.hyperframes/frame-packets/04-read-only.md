...
- ground: navy
- asset_candidates:
- handoff_in: the device continues from Frame 3 at x 540, y 1040, scale 1.0, opacity 1 — it dims to 0.45, it does not move
- handoff_out: the device — x 540, y 1040, scale 1.0, opacity 0.45, still
...
**dims to ~45%** and takes a soft defocus — a static state, not a tween so the foreground can own
