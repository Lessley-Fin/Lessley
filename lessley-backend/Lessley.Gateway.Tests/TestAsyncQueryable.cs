...
// Lets unit tests mock IQueryable<T> properties (e.g. UserManager.Users) that are
// consumed with ToListAsync — which requires IAsyncQueryProvider / IAsyncEnumerable<T>.
